# Tổng hợp tài liệu ôn thi olympic toán
...
- tải về thì có 2 cách
	...
	+ Cách 2: Clone về máy.
		+ Step 1: các bạn tải **git** [Bấm vào đây](https://git-scm.com/downloads) về máy vào trong 1 folder bạn muốn lưu tài liệu bật command.
		+ Step 2: gõ: **git init**.
